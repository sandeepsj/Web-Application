                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-3">
                                    <form role="form" action="closadmn.php" method="post" onsubmit="return checkInp();" name="adform" id="adform">
                                        <div class="input-group custom-search-form">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item">
                                                Parent's Name
                                                <span class="pull-right text-muted small"><?php echo $row["FATHERS-NAME"]; ?>
                                                </span>
                                            </div>
                                            <div class="list-group-item">
                                                 Parent's Occupation
                                                <span class="pull-right text-muted small"><?php echo $row["F-OCCUPATION"]; ?>
                                                </span>
                                            </div>
                                            <div class="list-group-item">
                                                School
                                                <span class="pull-right text-muted small"><?php echo $row["SCHOOL"]; ?>
                                                </span>
                                            </div>
                                            <div class="list-group-item">
                                                 Date of Admission
                                                <span class="pull-right text-muted small"><?php echo $row["DATE-OF-ADMN"]; ?>
                                                </span>
                                            </div>
                                            <div class="list-group-item">
                                                Date of Birth
                                                <span class="pull-right text-muted small"><?php echo $row["DOB"]; ?>
                                                </span>
                                            </div>
                                            <div class="list-group-item" >
                                                Address &nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp;&nbsp;<font color="#686868">
                                                <span class=""><?php echo $row["ADDRESS"]; ?>
                                                </span></font>
                                            </div>
                                            <div class="list-group-item">
                                                Phone Number
                                                <span class="pull-right text-muted small"><?php echo $row["PHONE"]; ?>
                                                </span>
                                            </div>
                                            <div class="list-group-item">
                                                Subject
                                            ...
                                            <br>
                                            <?php
                                            if($row["ADMN-STATUS"]=='open'){
                                            ?>
                                            <center>
                                            <form action="close.php" onsubmit="return confirmme()" method="post">
                                                <input type="hidden" name="admn" value=<?php echo $row["ADMN-NO"]; ?>>
                                                <input class="btn btn-primary" type="submit" name="clos" value="Close Admission">
                                            ...
                                            ?>
                                            <center>
                                            <form action="reopen.php" onsubmit="return confirmme()" method="post">
                                                <input type="hidden" name="admn" value=<?php echo $row["ADMN-NO"]; ?>>
                                                <input class="btn btn-primary" type="submit" name="clos" value="Reopen">
