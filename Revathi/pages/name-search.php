...
$abname=$_POST["name"];
$name="%".$_POST["name"]."%";
$sqlq="SELECT * FROM `studentdb` WHERE `NAME` LIKE '$name' OR `FATHERS-NAME` LIKE '$name'  OR `SUBJECT` LIKE '$name' OR `DATE-OF-ADMN` LIKE '$name' OR `ADMN-NO` LIKE '$abname' OR `PHONE` LIKE '$abname' OR `F-OCCUPATION` LIKE '$name' OR `SCHOOL` LIKE '$name' OR `ADMN-STATUS` LIKE '$abname';";
