...
<?php
        ...
        $sqlq="SELECT * FROM `studentdb`";
        $result=mysqli_query($conn,$sqlq);
        $sqlq="SELECT * FROM `studentdb` WHERE `ADMN-N0`>";
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    <div class="huge">
                                        <?php
                                            $date1=date("Y-m-d");
                                            $sql2="SELECT COUNT(`ADMN-NO`) AS `NEWSTD` FROM `studentdb` WHERE MONTH(`DATE-OF-ADMN`)=MONTH('$date1');";
                                            $re2=mysqli_query($conn,$sql2);
                                            $count=$re2->fetch_assoc();
                                            echo $count["NEWSTD"];
                                        ?>
                                    </div>
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <div>Fees Due More than 4 months</div>
                                </div>
                            </div>
                        </div>
