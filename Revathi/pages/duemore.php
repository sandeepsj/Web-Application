...
$limit=$_GET["limit"];
if ($limit==4) {
    $sqlq="SELECT * FROM `DUE` WHERE `T`>4";
    $result=$conn->query($sqlq);
}
else{
    $sqlq="SELECT * FROM `DUE` WHERE `T`=$limit";
    $result=$conn->query($sqlq);
}
?>
<head>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php 
                                                $admn=$row['ADMN-NO'];
                                                $getstdb=mysqli_query($conn,"SELECT * FROM `studentdb` WHERE `ADMN-NO`=$admn");
                                                $row2=$getstdb->fetch_assoc();
                                            ?>
                                            <td><?php echo $row2["NAME"]?></td>
                                            <td><?php echo $row2["FATHERS-NAME"]?></td>
